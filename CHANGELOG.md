...
- Качество SEO-автозаполнения улучшено для сложных EN-prompts: добавлены контекстные RU-хайлайты сцены (style/action/composition), усилены анти-шаблонные правила для title/description и введён multi-model fallback OpenRouter (`OPENROUTER_SEO_MODELS`).
