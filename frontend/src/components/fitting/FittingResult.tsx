    ...
    <div className="max-w-2xl mx-auto px-4 py-6">
      ...
      >
        ...
        <p className="text-xs text-gray-500 mb-4">
          Результат генерируется внешним AI-сервисом. Итоговое изображение может отличаться от ваших ожиданий; проверяйте результат перед скачиванием или публикацией.
        </p>
