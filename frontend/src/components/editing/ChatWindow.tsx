          ...
          >
            <Card variant="glass" padding="lg" className="border border-primary-200">
              ...
              <p className="mt-4 text-sm text-dark-600">
                Опишите, что хотите изменить. При необходимости прикрепите дополнительные изображения через скрепку. После ввода можно отправить запрос сразу или попросить AI ({promptAssistantModel}) улучшить формулировку (спишет 1 кредит) перед генерацией.
              </p>
            </Card>
          </motion.div>
        )}
