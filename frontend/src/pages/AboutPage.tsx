...
const FEATURES = [
  ...
  },
  {
    ...
    description: 'Чат‑редактор с референсами и возможностью улучшить промпт перед генерацией.',
    icon: '🎨',
  },
  {
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
              <div>
                ...
                <p className="text-sm text-dark-600">
                  Примерка и редактирование фото с помощью искусственного интеллекта.
                </p>
              </div>
