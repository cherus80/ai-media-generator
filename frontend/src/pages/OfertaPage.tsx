...
export const OfertaPage: React.FC = () => {
  ...
  useSeo({
    title: 'Публичная оферта — ИИ Генератор',
    description: 'Условия оказания услуг виртуальной примерки и ИИ-редактирования.',
      ...
      <div className="max-w-5xl mx-auto px-4 py-8 space-y-8">
        <Card variant="glass" padding="lg" className="border border-primary-200">
          ...
          <ul className="space-y-2 text-dark-700 text-sm leading-relaxed">
            <li><strong>Сервис</strong> — ИИ Генератор (виртуальная примерка и ИИ-редактирование изображений), домен ai-generator.mix4.ru.</li>
        ...
        <Card variant="glass" padding="lg" className="border border-primary-200">
          ...
          <p className="text-dark-700 text-sm leading-relaxed">
            Исполнитель предоставляет доступ к функционалу Сервиса (виртуальная примерка, ИИ-редактирование изображений, хранение истории) на возмездной основе по условиям настоящей оферты.
          </p>
        </Card>
        ...
        <Card variant="glass" padding="lg" className="border border-primary-200 space-y-3">
          ...
          <ul className="space-y-2 text-dark-700 text-sm leading-relaxed">
            <li>
              Генерация изображений выполняется сторонними моделями (внешний ИИ-провайдер). Результат формируется автоматизированно, Исполнитель не контролирует работу алгоритмов, не гарантирует точность,
