      ...
      <div className="max-w-5xl mx-auto px-4 py-8 space-y-6">
        <Card variant="glass" padding="lg" className="border border-primary-200">
          ...
          <ul className="space-y-2 text-dark-700 text-sm leading-relaxed">
            ...
            <li>Состав данных: эл. почта, имя/фамилия (если указаны), платежные идентификаторы (от ЮKassa), загруженные изображения и сообщения чата, технические данные (IP, user-agent, cookie/токены).</li>
            <li>Действия с данными: сбор, запись, систематизация, хранение, уточнение, использование, передача (в т.ч. ЮKassa и ИИ-провайдерам), обезличивание, блокирование и уничтожение.</li>
            <li>Трансграничная передача: возможна при использовании внешних ИИ/SMTP-провайдеров; пользователь соглашается на такую передачу для оказания услуги.</li>
        ...
        <Card variant="glass" padding="lg" className="border border-primary-200">
          ...
          <ul className="space-y-2 text-dark-700 text-sm leading-relaxed">
            <li>Эл. почта, имя и фамилия (если указаны) — для регистрации и коммуникации.</li>
        ...
        <Card variant="glass" padding="lg" className="border border-primary-200">
          ...
          <ul className="space-y-2 text-dark-700 text-sm leading-relaxed">
            <li>Оказание услуг по виртуальной примерке и ИИ-редактированию.</li>
            <li>Отправка служебных писем (подтверждение эл. почты, статус операций, безопасность).</li>
        ...
        <Card variant="glass" padding="lg" className="border border-primary-200">
          ...
          <ul className="space-y-2 text-dark-700 text-sm leading-relaxed">
            ...
            <li>ИИ-генерация выполняется сторонними моделями — изображения и промпты могут передаваться провайдеру модели.</li>
        ...
        <Card variant="glass" padding="lg" className="border border-primary-200">
          ...
          <ul className="space-y-2 text-dark-700 text-sm leading-relaxed">
            ...
            <li>Телефон: +7 913 220-69-67, эл. почта: ai-generator@mix4.ru.</li>
          </ul>
        </Card>
      </div>
    </Layout>
